            ...
            if ($validation_code) {
                ...
                if ($this->settings->email_user_activation == 'YES') {
                    ...
                    if ($mail_status) {
                        ...
                        $this->session->set_flashdata('message', "Congratulation Registered Successfully", $this->input->post('first_name', TRUE));
                    ...
                    $this->session->set_flashdata('message', "Congratulationsssssss Register Successfully", $this->input->post('first_name', TRUE));
                }
            } else {
