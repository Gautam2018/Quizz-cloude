...
$route['admin/rating/(:any)'] 					= 'admin/RatingController/index/$1';
...
$route['blog/list1/(:any)']         			= 'Blog_Controller/list1/$1';	// this will be list of posts, from specific category 
$route['blog/list1/(:any)/(:any)']         			= 'Blog_Controller/list1/$1/$2';	// this will be list of posts, from specific category  
...
$route['razorpay/checkout/quiz/(:any)']         			= 'Razorpay/index/$1';
$route['razorpay/payment/quiz/(:any)']         			= 'Razorpay/create_payment/$1';
$route['razorpay/verify/quiz/(:any)']         			= 'Razorpay/verify/$1';
$route['razorpay/quiz-payment/(:any)']         			= 'Razorpay/quiz_payment/$1';
