      ...
      <div class="row">
         <div class="col-12 "> 
            <ul class="nav nav-tabs m-0 p-0 bg-white" id="my-profile-Tab" role="tablist">
               ...
               <li class="nav-item w-30">
                  <a class="nav-link " id="quiz-purchased-tab" data-toggle="tab" href="#quiz-purchased" role="tab" aria-controls="purchased" aria-selected="true"><?php echo lang('purchased_quiz'); ?></a> 
               </li>
               <li class="nav-item w-30">
                  <a class="nav-link " id="quiz-like-tab" data-toggle="tab" href="#quiz-like" role="tab" aria-controls="fav-product" aria-selected="true"><?php echo lang('like_quiz'); ?></a> 
               </li>
               <li class="nav-item w-30">
                  <a class="nav-link " id="post-like-tab" data-toggle="tab" href="#post-like" role="tab" aria-controls="fav-post" aria-selected="true"><?php echo lang('like_post'); ?></a> 
               </li>
               <li class="nav-item w-30">
                  <a class="nav-link " id="payment-list-tab" data-toggle="tab" href="#payment-list" role="tab" aria-controls="payment" aria-selected="true"><?php echo lang('dashboard_payment'); ?></a> 
               </li>
            </ul>
