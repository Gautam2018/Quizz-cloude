              ...
              <ul class="navbar-nav nav nav-tabs navbar-right  border-0">
                ...
                if($menu_category_array)
                {
                  ...
                  if(isset($this->user['id']))
                  {
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url('my/history'); ?>" class="nav-link  <?php echo (uri_string() == "my/history") ? "active" : ""; ?>"> <?php echo lang('quiz_history'); ?></a>
                    </li>
                    <?php
                  }
...
<!--                  <li class="nav-item">
                    <a class="nav-link <?php echo (uri_string() == "blog/list/all") ? "active" : (($this->uri->segment(2) == "post") ? "active" : (($this->uri->segment(2) == "category") ? "active" : "")); ?>" href="<?php echo base_url("blog");?>">
                      <?php echo lang('admin_blog');?>
